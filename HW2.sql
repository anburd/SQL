...
-- NULL это отсутсвие значений в ячейке ("пустое место") — объявленная, но неинициализированная переменная, объект и т.п., а 0 это числло, значение с которым можно производить математические вычисления.
